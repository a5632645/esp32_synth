...
#define MYFP_FROM_FLOAT(FLOAT_VAL) ((MyFp1_15)((FLOAT_VAL) * (1 << 15)))
#define MYFP_TO_FLOAT(MYFP_VAL) ((float)(MYFP_VAL) / (float)(1 << 15))
...
inline void MyFp_FromFloat(MyFpFloatBundleT* a0, MyFpInt128T* result) {
    result->s16[0] = MYFP_FROM_FLOAT(a0->f32[0]);
    result->s16[1] = MYFP_FROM_FLOAT(a0->f32[1]);
    result->s16[2] = MYFP_FROM_FLOAT(a0->f32[2]);
    result->s16[3] = MYFP_FROM_FLOAT(a0->f32[3]);
    result->s16[4] = MYFP_FROM_FLOAT(a0->f32[4]);
    result->s16[5] = MYFP_FROM_FLOAT(a0->f32[5]);
    result->s16[6] = MYFP_FROM_FLOAT(a0->f32[6]);
    result->s16[7] = MYFP_FROM_FLOAT(a0->f32[7]);
}
inline void MyFp_ToFloat(MyFpInt128T* a0, MyFpFloatBundleT* result) {
